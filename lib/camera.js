        ...
        radius_min = 2.0, radius_max = 100)
{
            ...
            switch (event.key) {
                ...
                default:
                    if(!isNaN(event.key) && +event.key>=0 && +event.key<=9){
                        ...
                        set_camera_center(numkeys_cam_settings[parseInt(event.key)].center);
                    }
                    else{
                        cam_moved = false;
                    }
    ...
    function get_picking_ray(position, view_width, view_height) {
        ...
        glMatrix.mat4.multiply(tmp_mat, Projection, View);
    ...
    function set_camera_orientation(camera_zenith, camera_azimuth, camera_radius){
        cam_zenith  = camera_zenith;
        cam_azimuth = camera_azimuth;
        cam_radius  = camera_radius;
    }

    function set_camera_center(center) {
        world_center  = center;
    }

    function center_camera() {
        set_camera_orientation(0.0, 0.0, 16.0);
        set_camera_center(
