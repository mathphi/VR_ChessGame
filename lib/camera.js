        ...
        radius_min = 2.0, radius_max = 100)
{
    ...
    const numkeys_cam_settings = [
        {zenith: 0.0, azimuth: 0.0, radius: 16.0, center: glMatrix.vec3.fromValues(0.0, 0.0, 0.0)}, // 0
        {zenith: 0.0, azimuth: 0.0, radius: 16.0, center: glMatrix.vec3.fromValues(0.0, 0.0, 0.0)}, // 1
        {zenith: 0.0, azimuth: 0.0, radius: 16.0, center: glMatrix.vec3.fromValues(0.0, 0.0, 0.0)}, // 2
        {zenith: 0.0, azimuth: 0.0, radius: 16.0, center: glMatrix.vec3.fromValues(0.0, 0.0, 0.0)}, // 3
        {zenith: 0.0, azimuth: 0.0, radius: 16.0, center: glMatrix.vec3.fromValues(0.0, 0.0, 0.0)}, // 4
        {zenith: 0.0, azimuth: 0.0, radius: 16.0, center: glMatrix.vec3.fromValues(0.0, 0.0, 0.0)}, // 5
        {zenith: 0.0, azimuth: 0.0, radius: 16.0, center: glMatrix.vec3.fromValues(0.0, 0.0, 0.0)}, // 6
        {zenith: 0.0, azimuth: 0.0, radius: 16.0, center: glMatrix.vec3.fromValues(0.0, 0.0, 0.0)}, // 7
        {zenith: 0.0, azimuth: 0.0, radius: 16.0, center: glMatrix.vec3.fromValues(0.0, 0.0, 0.0)}, // 8
        {zenith: 0.0, azimuth: 0.0, radius: 16.0, center: glMatrix.vec3.fromValues(0.0, 0.0, 0.0)}, // 9
    ];
