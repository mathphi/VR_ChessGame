...
const make_chessboard = async function(gl, phys_eng, lights_set, basedir = '.') {
    const _piece_meshes = {
        p: await load_obj(basedir + '/objects/pieces/pawn.obj', false),
        b: await load_obj(basedir + '/objects/pieces/bishop.obj', false),
        r: await load_obj(basedir + '/objects/pieces/rook.obj', false),
        n: await load_obj(basedir + '/objects/pieces/knight.obj', false),
        q: await load_obj(basedir + '/objects/pieces/queen.obj', false),
        k: await load_obj(basedir + '/objects/pieces/king.obj', false)
    }
    const _piece_cboxes = {
        p: await load_obj(basedir + '/objects/collision_boxes/c_pawn.obj', false),
        b: await load_obj(basedir + '/objects/collision_boxes/c_bishop.obj', false),
        r: await load_obj(basedir + '/objects/collision_boxes/c_rook.obj', false),
        n: await load_obj(basedir + '/objects/collision_boxes/c_knight.obj', false),
        q: await load_obj(basedir + '/objects/collision_boxes/c_queen.obj', false),
        k: await load_obj(basedir + '/objects/collision_boxes/c_king.obj', false)
    }
    ...
    async function setupMoveSquares() {
        const ms_mesh = await load_obj(basedir + '/objects/square_plane.obj', false);
    ...
    function setChessPieceSelection(new_select) {
        ...
        if (new_select !== null && current_select_piece !== new_select) {
            // Move upward
    ...
    const chessboard_mesh = await load_obj(basedir + '/objects/chessboard.obj' ,true);
