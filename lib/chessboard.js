const make_chessboard = async function(gl, phys_eng, lights_set, ai_on, basedir = '.') {
    ...
    function checkMoveFlag(move){
        ...
        if (move.flags.includes('n') || move.flags.includes('b')) {
            ...
            move_success = processPieceMove(letterToGamePosition(move.to));
        }
    ...
    function processAIMove(){
        ...
        const move = ai.findBestMove(_chess_js_inst);
    ...
    function processPieceCastling(move_data) {
        ...
        if (move_result !== null) {
            ...
            // Oooooops...
            console.warn(`Invalid castling: from '${from_pos_san}' to '${target_pos_san}' !!!`);
            return false;
        }
    }
